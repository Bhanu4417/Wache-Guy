...
{ imgLoaded && <Link to="/blogs/blog2" className="card   bg-white/5
  backdrop-blur-md
  border border-white/15
  shadow-[0_8px_30px_rgba(0,0,0,0.25)] md:px-4 md:py-3 px-2 py-2 cursor-pointer"><img className='md:w-100 h-auto' src="/Blogs/THE QUEST 3.svg" />
<div className="flex gap-2">
 <div className="flex items-center md:mt-2 mt-2">
  <div className="flex items-center gap-2 text-black bg-white w-fit px-2 py-1 font-semibold rounded-[5px]">
    <img
  ...
  <div className="day text-white md:text-[26px] text-[20px] font-medium md:font-bold md:mt-3 mt-2">Day 2 - A bare nice one!</div>
  <div className="date text-[#71717b]">30 December 2025</div>
</Link>}
{ imgLoaded && <Link to="/blogs/blog3" className="card   bg-white/5
  backdrop-blur-md
  border border-white/15
  shadow-[0_8px_30px_rgba(0,0,0,0.25)] md:px-4 md:py-3 px-2 py-2 cursor-pointer"><img className='md:w-100 h-auto' src="/Blogs/THE QUEST 4.svg" />
<div className="flex gap-2">
 <div className="flex items-center md:mt-2 mt-2">
  <div className="flex items-center gap-2 text-black bg-white w-fit px-2 py-1 font-semibold rounded-[5px]">
    <img
  ...
  <div className="day text-white md:text-[26px] text-[20px] font-medium md:font-bold md:mt-3 mt-2">Day 3 - A nice one!</div>
  <div className="date text-[#71717b]">1 January 2025</div>
</Link>}
