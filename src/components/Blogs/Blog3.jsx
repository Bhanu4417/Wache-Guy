...
<div className="text-white text-[34px] font-bold md:text-[48px] md:mt-3 mt-2">Day 3 - A Nice One!</div>
...
<img className='md:mt-6 mt-3' src="/Blogs/THE QUEST 4.svg" />
<div className="text-white text-[20px] md:mt-3 mt-2">This is the day 1 of my challenge.</div>
<div className="text-[white] md:text-[18px] text-[15px] mt-3"><p>So today I designed the start page of my music app learned framer motion more nothing more.</p></div>
