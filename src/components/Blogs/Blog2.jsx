...
const Blog0 = () => {
 ...
 max-w-[720px] mx-auto px-4 sm:px-6 md:px-8 pt-20 pb-24">
  <div className="text-[#949494] md:mt-1 mt-2 text-[14px] md:text-[16px]">Published on December 30, 2025</div>
<div className="text-white text-[34px] font-bold md:text-[48px] md:mt-3 mt-2">A Not too good day!</div>
...
<img className='md:mt-6 mt-3' src="/Blogs/THE QUEST 3.svg" />
<div className="text-white text-[20px] md:mt-3 mt-2">This is the day 2 of my challenge.</div>
<div className="text-[white] md:text-[18px] text-[15px] mt-3"><p>So today was not that good day but a still nice when I learned connecting my frontend to backend with express create a login page which shares login credentials to mongo db learned using pass hash.</p></div>
